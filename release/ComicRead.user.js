...
//#endregion
`};let supportWorker;const gmApi={GM:typeof GM>"u"?void 0:GM,GM_addElement:typeof GM_addElement>"u"?void 0:GM_addElement,GM_getResourceText:typeof GM_getResourceText>"u"?void 0:GM_getResourceText,GM_xmlhttpRequest:typeof GM_xmlhttpRequest>"u"?void 0:GM_xmlhttpRequest,unsafeWindow:typeof unsafeWindow>"u"?window:unsafeWindow},gmApiList=Object.keys(gmApi),{trustedTypes}=unsafeWindow;if(trustedTypes)try{trustedTypes.defaultPolicy||trustedTypes.createPolicy("default",{createHTML:e=>e,createScript:e=>e,createScriptURL:e=>e,createURL:e=>e})}catch{}const crsLib={process:{env:{NODE_ENV:"production"}},...gmApi},tempName=Math.random().toString(36).slice(2),getResource=e=>{const t=gmApi.GM_getResourceText?.(e.replaceAll("/","|").replaceAll("@","_"));if(!t)throw new Error(`\u5916\u90E8\u6A21\u5757 ${e} \u672A\u5728 @Resource \u4E2D\u58F0\u660E`);return e==="@tensorflow/tfjs-backend-webgpu"?t.replace("@tensorflow/tfjs-core","@tensorflow/tfjs"):t},evalCode=e=>{if(e){if(gmApi.GM_addElement)return GM_addElement("script",{textContent:e})?.remove();eval.call(gmApi.unsafeWindow,e)}},selfImport=e=>{let t=libCodeMap[e]??getResource(e);if(e.startsWith("worker/")&&supportWorker)try{const r=new Map([["Comlink",getResource("comlink")]]),a=l=>l.replaceAll(/require\(['"](?<moduleName>.+?)['"]\)/gu,(d,c)=>(r.has(c)||r.set(c,a(getResource(c))),`moduleMap['${c}']`)),s=a(t);let n=`const moduleMap = {};
`;for(const[l,d]of r)n+=`
moduleMap['${l}'] = {};
(function (exports, module) { ${d} }) (
  moduleMap['${l}'],
  {
    set exports(value) { moduleMap['${l}'] = value; },
    get exports() { return moduleMap['${l}']; }
  },
);
`;n+=`
const exports = {};
${s}
moduleMap['Comlink'].expose(exports);`;const i=URL.createObjectURL(new Blob([n],{type:"text/javascript"}));setTimeout(()=>URL.revokeObjectURL(i));const g=new Worker(i);crsLib[e]=require("comlink").wrap(g);return}catch{}let o=`
  ...
  `;gmApi.unsafeWindow[tempName]=crsLib,gmApi.unsafeWindow[tempName][e]={},evalCode(o),Reflect.deleteProperty(gmApi.unsafeWindow,tempName)},require=e=>{const t={value:!0},o=()=>{};o.default={};const r=new Proxy(o,{get(a,s){return s==="__esModule"?t:s==="default"?r:(crsLib[e]||selfImport(e),Reflect.has(crsLib[e],"default")&&Reflect.has(crsLib[e].default,s)?crsLib[e].default[s]:crsLib[e][s])},apply(a,s,n){crsLib[e]||selfImport(e);const i=crsLib[e];return(typeof i.default=="function"?i.default:i)(...n)},construct(a,s){crsLib[e]||selfImport(e);const n=crsLib[e];return new(typeof n.default=="function"?n.default:n)(...s)},ownKeys(){return crsLib[e]||selfImport(e),Reflect.ownKeys(crsLib[e])},getOwnPropertyDescriptor(){return{enumerable:!0,configurable:!0}}});return r};crsLib.require=require,{supportWorker}=require("userscript/supportWorker");let core=require("core"),helper=require("helper"),helper_languages=require("helper/languages"),request=require("request"),userscript_copyApi=require("userscript/copyApi"),userscript_otherSite=require("userscript/otherSite");const nhApi=(e,t)=>core.request(e,{responseType:"json",headers:{"User-Agent":navigator.userAgent},fetch:!1,...t}),getNhentaiData=async e=>{const{response:t}=await nhApi(`https://nhentai.net/api/v2/galleries/${e}`,{errorText:helper.t("site.ehentai.nhentai_error"),noTip:!0});return t},toImgList=e=>e.pages.map(t=>({src:`https://i.nhentai.net/${t.path}`,width:t.width,height:t.height}));try{switch(location.hostname){case"bbs.yamibo.com":selfImport("site/yamibo");break;case"www.yamibo.com":selfImport("site/newYamibo");break;case"exhentai.org":case"e-hentai.org":selfImport("site/ehentai");break;case"nhentai.net":selfImport("site/nhentai");break;case"yuri.website":selfImport("site/yurifans");break;case"www.copy5000.com":case"www.copy4000.com":case"www.copy3000.com":case"copy3000.com":case"www.2026copy.com":case"2026copy.com":case"www.2025copy.com":case"2025copy.com":case"www.copy20.com":case"copy20.com":case"mangacopy.com":case"www.mangacopy.com":selfImport("site/copymanga");break;case"www.zaimanhua.com":case"manhua.zaimanhua.com":selfImport("site/zaimanhua");break;case"m.zaimanhua.com":selfImport("site/zaimanhua");break;case"tw.manhuagui.com":case"m.manhuagui.com":case"www.mhgui.com":case"www.manhuagui.com":selfImport("site/manhuagui");break;case"www.manhuaren.com":case"m.1kkk.com":case"www.1kkk.com":case"tel.dm5.com":case"en.dm5.com":case"cnc.dm5.com":case"www.dm5.cn":case"www.dm5.com":selfImport("site/dm5");break;case"www.mangabz.com":case"mangabz.com":selfImport("site/mangabz");break;case"komiic.com":case"komiic.cc":selfImport("site/komiic");break;case"8.twobili.com":case"a.twobili.com":case"articles.onemoreplace.tw":case"www.8comic.com":{if(!/^\/(?:online|ReadComic|comic)\//u.test(location.pathname))break;request.downloadImgHeaders.Referer="https://www.8comic.com/";const e=()=>Array.from(unsafeWindow.xx.matchAll(/(?<= s=").+?(?=")/gu),([t])=>decodeURIComponent(t));core.setup({name:"8comic",getImgList:e,onNext:()=>helper.querySelectorClick("#nextvol"),onPrev:()=>helper.querySelectorClick("#prevvol")});break}case"www.wn10.cfd":case"www.wn10.shop":case"www.wnacg.com":case"wnacg.com":selfImport("site/wnacg");break;case"siteUrl#jm":case"18comic.org":case"18comic.vip":selfImport("site/jm");break;case"noymanga.com":selfImport("site/noyacg");break;case"noy1.top":selfImport("site/noyacg");break;case"www.relamanhua.org":case"www.manga2024.com":case"www.2024manga.com":if(!location.pathname.includes("/chapter/"))break;if(!document.querySelector(".disData[contentkey]")){core.toast.error(helper.t("site.changed_load_failed"));break}core.setup({name:"relamanhua",getImgList:()=>userscript_copyApi.getImglistByHtml(),onNext:()=>helper.querySelectorClick(".comicContent-next a:not(.prev-null)"),onPrev:()=>helper.querySelectorClick(".comicContent-prev:not(.index,.list) a:not(.prev-null)")});break;case"hanime1.me":case"hanimeone.me":if(!location.pathname.startsWith("/comic/"))break;core.setup({name:"hanime1",getImgList:async()=>{const e=await helper.wait(()=>helper.querySelector(".comics-metadata-margin-top a:has(span.material-icons)")),t=/\/g\/(?<id>\d+)\//u.exec(e.href)?.groups?.id;if(!t)throw new Error(helper.t("site.changed_load_failed"));const o=await getNhentaiData(t);return toImgList(o)}});break;case"ex.810114.xyz":case"e.810114.xyz":case"ex.moonchan.xyz":selfImport("site/ehentai");break;case"hitomi.la":selfImport("site/hitomi");break;case"hdoujin.org":selfImport("site/hdoujin");break;case"shupogaki.moe":case"hoshino.one":case"niyaniya.moe":selfImport("site/schale");break;case"nude-moon.org":selfImport("site/nude-moon");break;case"hentaizap.com":case"imhentai.xxx":case"hentaiera.com":case"hentaienvy.com":selfImport("site/hentaienvy");break;case"eahentai.com":{const e=()=>/^\/a\/(?<albumId>\d+)(?:\/(?<page>\d+))?/u.exec(location.pathname)?.groups;if(!e())break;core.setup({name:"EAHentai",isMangaPage:e,initOptions:{autoShow:!1},async getImgList(t,{albumId:o,page:r}){const a=r?document:helper.domParse((await core.request(`/a/${o}/0`)).responseText);return Array.from(a.querySelectorAll('main img[src*="i.eahentai.com/file/ea-gallery"]'),s=>s.src)}});break}case"hentainexus.com":selfImport("site/hentainexus");break;case"asmhentai.com":selfImport("site/asmhentai");break;case"3hentai.net":selfImport("site/3hentai");break;case"mangadex.org":selfImport("site/mangadex");break;case"nicomanga.com":{const e=()=>unsafeWindow.chapterImages;core.setup({name:"welovemanga",isMangaPage:()=>helper.wait(()=>e()?.length>0),getImgList:e,onNext:()=>helper.querySelectorClick(".next-chapter"),onPrev:()=>helper.querySelectorClick(".prev-chapter")});break}case"weloma.art":case"love4u.net":{if(!helper.querySelector("#chapter-images img"))break;const e=o=>{const r=o.dataset.srcset||o.dataset.original||o.dataset.src||o.src;if(r&&!r.endsWith(".gif"))return r.trim();if(o.dataset.img)return atob(o.dataset.img)},t=()=>helper.querySelectorAll("#chapter-images img").map(e).filter(Boolean);core.setup({name:"welovemanga",getImgList:t,onNext:()=>helper.querySelectorClick(".rd_top-right.next:not(.disabled)"),onPrev:()=>helper.querySelectorClick(".rd_top-left.prev:not(.disabled)")});break}case"old.klz9.com":case"klz9.com":selfImport("site/klz9");break;case"pawchive.pw":case"kemono.cr":case"kemono.su":case"kemono.party":selfImport("site/kemono");break;case"nekohouse.su":if(!location.pathname.includes("/post/"))break;core.setup({name:"nekohouse",getImgList:()=>helper.querySelectorAll(".fileThumb").map(e=>e.getAttribute("href")),initOptions:{autoShow:!1,defaultOption:{pageNum:1}}});break;case"www.pixiv.net":selfImport("site/pixiv");break;case"weibo.com":selfImport("site/weibo");break;case"comic.hypergryph.com":selfImport("site/terrahistoricus");break;case"postimg.cc":{const e=helper.querySelectorAll("#thumb-list [data-hotlink]");if(e.length<=1)break;core.setup({name:"postimg",getImgList:()=>e.map(t=>`https://i.postimg.cc/${t.dataset.hotlink}/${t.dataset.name}.${t.dataset.ext}`)});break}case"manga.nicovideo.jp":selfImport("site/nico");break;case"sai-zen-sen.jp":selfImport("site/sai-zen-sen");break;case"geinou-nude.com":{const e=helper.querySelectorAll("main img.size-medium").map(t=>{const o=t.dataset.src??"",r=/-(?<w>\d+)x(?<h>\d+)\.[a-z]+$/iu.exec(o)?.groups;return r?{src:o,width:Number(r.w),height:Number(r.h)}:o});if(e.length===0)break;core.setup({name:"geinou-nude",getImgList:()=>e});break}case"comic-read.pages.dev":unsafeWindow.GM_xmlhttpRequest=GM_xmlhttpRequest,unsafeWindow.toast=core.toast;break;default:document.querySelector(`head > meta[content="A manga reader that runs tachiyomi's extensions"]`)?selfImport("site/suwayomi"):location.pathname==="/reader"&&document.querySelector('.ip > a[href="https://github.com/Difegue/LANraragi"]')?.textContent.trim()==="LANraragi."&&selfImport("site/lanraragi"),(async()=>{if(await GM.getValue(location.hostname)!==void 0)return helper.requestIdleCallback(userscript_otherSite.otherSite);await GM.registerMenuCommand((e=>{switch(e){case"en":return"Enter simple reading mode";case"ru":return"\u0412\u043A\u043B\u044E\u0447\u0438\u0442\u044C \u043F\u0440\u043E\u0441\u0442\u043E\u0439 \u0440\u0435\u0436\u0438\u043C \u0447\u0442\u0435\u043D\u0438\u044F";default:return"\u4F7F\u7528\u7B80\u6613\u9605\u8BFB\u6A21\u5F0F"}})(await helper_languages.getInitLang()),()=>userscript_otherSite.otherSite())})()}}catch(e){helper.log.error(e)}
