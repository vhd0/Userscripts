...
const exports = {};
${s}
moduleMap['Comlink'].expose(exports);`;const i=URL.createObjectURL(new Blob([n],{type:"text/javascript"}));setTimeout(()=>URL.revokeObjectURL(i));const p=new Worker(i);crsLib[e]=require("comlink").wrap(p);return}catch{}let o=`
